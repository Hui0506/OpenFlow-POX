...
class RouterExercise(object):
	...
	def __init__(self, connection):
		...
		self.mac_to_port = {}
		self.route_table = {
			'10.0.1.1': ['00:00:00:00:11:05', '10.0.1.0/24', 'R', 3],
			'10.0.1.2': ['00:00:00:00:00:01', '10.0.1.0/24', 'H', 1],
			'10.0.1.3': ['00:00:00:00:00:02', '10.0.1.0/24', 'H', 2],
			'10.0.2.1': ['00:00:00:00:11:06', '10.0.2.0/24', 'R', 2],
			'10.0.2.2': ['00:00:00:00:00:03', '10.0.2.0/24', 'H', 1],
			'10.0.3.1': ['00:00:00:00:11:07', '10.0.3.0/24', 'R', 2],
			'10.0.3.2': ['00:00:00:00:00:04', '10.0.3.0/24', 'H', 1]}
	...
	def ICMP_Request_handler(self, packet, packet_in):
		...
		if ipDstAdd != None:
			if str(packet.dst) == '00:00:00:00:11:05':
				...
				if str(ip_packet.dstip) == '10.0.3.1':
					echo_segment = pkt.echo()
					echo_segment.seq = icmp_segment.payload.seq + 1
					echo_segment.id = icmp_segment.payload.id
					#icmp packt|echo
